(() => {
  ...
  style.textContent = `
    @font-face{font-family:"NTX Source Han";src:url("assets/fonts/SourceHanSerifSC-Web.woff2") format("woff2");font-weight:200 900;font-style:normal;font-display:swap}@font-face{font-family:"NTX Big Caslon";src:url("assets/fonts/Big-Caslon-Medium.ttf") format("truetype");font-weight:400 500;font-display:swap}
    ...
    .language-notice-message .language-notice-zh{font-family:"NTX Source Han","Source Han Serif SC",serif!important}.language-notice-message .language-notice-en{font-family:"NTX Big Caslon","Big Caslon","Times New Roman",serif!important}
  ...
  if (!switcher.dataset.sharedBound) {
    ...
    switcher.addEventListener('click', () => {
      ...
      document.querySelectorAll('[data-guide-en][data-guide-zh]').forEach((node)=>{node.textContent=node.dataset[target==='zh'?'guideZh':'guideEn'];node.dataset.guideLanguage=target});
    });
  }
})();
